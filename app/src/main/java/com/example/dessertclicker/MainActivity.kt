        ...
        Column {
            Row(
                ...
                Image(
                    ...
                    contentDescription = stringResource(R.string.dessert1),
                    modifier = Modifier
                        .width(150.dp)
                        .height(150.dp)
                ...
                //Spacer(modifier = Modifier.width(16.dp)) // Tạo khoảng cách giữa 2 hình ảnh
                Image(
                    painter = painterResource(dessertImageId2),
                    contentDescription = stringResource(R.string.dessert2),
                    modifier = Modifier
                        .width(150.dp)
                        .height(150.dp)
...
private fun TransactionInfo(
    ...
    Column(
        modifier = modifier
            .fillMaxWidth() // Lấp đầy màn hình
            .background(Color.White),
        verticalArrangement = Arrangement.Bottom // Đưa xuống dưới
    ) {
...
fun MyDessertClickerAppPreview() {
    DessertClickerTheme {
        DessertClickerApp(
            uiState = DessertUiState(),
            onDessert1Clicked = {},  // Thêm callback mới
            onDessert2Clicked = {}   // Thêm callback mới
        )
    }
}
